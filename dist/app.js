	...
	render: function() {
		...
		return React.createElement("div", null, 
			React.createElement("div", {className: "file-selector"}, 
				React.createElement("h1", null, "File Viewer Sample Application"), 
				React.createElement("label", null, 
					"File:", 
					React.createElement("select", {onChange: this.fileSelected}, 
						React.createElement("option", {value: ""}, "-- Select a File --"), 
						this.props.files.map(function(file) {
							return React.createElement("option", {key: file.src}, file.name);
						})
					)
				)
			), 
...
React.render(
	React.createElement(Main, {files: files}),
	document.getElementById('placeholder')
);

},{"../src/fileViewer.js":158,"react":156}],158:[function(require,module,exports){
'use strict';
...
var React = require('react'),
	...
	pdfNative = require('./plugins/pdf/nonNativeViewer.js');
...
var FileViewer = React.createClass({displayName: "FileViewer",
	propTypes: {
	...
	render: function() {
		...
		return (React.createElement("div", {className: "vui-fileviewer"}, viewer));
	}
});

module.exports = FileViewer;

},{"./getExtension":159,"./plugins/generic/generic.js":163,"./plugins/html/native.js":167,"./plugins/image.js":169,"./plugins/pdf/nonNativeViewer.js":170,"react":156}],159:[function(require,module,exports){
'use strict';
...
var Download = React.createClass({displayName: "Download",
	...
	render: function() {
		...
		return React.createElement("div", {className: "vui-fileviewer-generic-download"}, 
			React.createElement("button", {onClick: this.download}, "Download")
		);
	}
});
...
var Filename = React.createClass({displayName: "Filename",
	render: function() {
		...
		return React.createElement("div", {className: "vui-fileviewer-generic-filename"}, filename);
	}
});
...
var plugin = {
	getComponent: function(props) {
		return (React.createElement(Viewer, React.__spread({},  props)));
	},
	test: function() {
		return true;
	}
...
},{"./viewer":166,"react":156}],164:[function(require,module,exports){
'use strict';
...
},{"../../getExtension":159,"../../getIconClassName":160,"react":156}],165:[function(require,module,exports){
'use strict';
...
var Size = React.createClass({displayName: "Size",
	render: function() {
		...
		return React.createElement("div", {className: "vui-fileviewer-generic-size"}, this.props.value);
	}
});
...
var Viewer = React.createClass({displayName: "Viewer",
	render: function() {
		return (React.createElement("div", {className: "vui-fileviewer-generic"}, 
			React.createElement(Icon, {src: this.props.src}), 
			React.createElement("div", {className: "vui-fileviewer-generic-main"}, 
				React.createElement(Filename, {src: this.props.src}), 
				React.createElement(Size, {value: this.props.size}), 
				React.createElement(Download, {src: this.props.srcdownload})
			)
		));
	}
});
...
},{"./download.js":161,"./filename.js":162,"./icon.js":164,"./size.js":165,"react":156}],167:[function(require,module,exports){
'use strict';
...
var plugin = {
	getComponent: function(props) {
		return React.createElement(NativeViewer, React.__spread({},  props));
	},
...
},{"./nativeViewer":168,"react":156}],168:[function(require,module,exports){
'use strict';

var React = require('react'),
	GenericViewer = require('../generic/viewer.js');

var NativeViewer = React.createClass({displayName: "NativeViewer",
	componentDidMount: function() {
	...
	render: function() {
		...
		return React.createElement("iframe", {
			...
			ref: "wrapper", 
			style: style}, 
			React.createElement(GenericViewer, React.__spread({},  this.props)), ";"
		);
	}
});
...
},{"../generic/viewer.js":166,"react":156}],169:[function(require,module,exports){
'use strict';
...
var ImageViewer = React.createClass({displayName: "ImageViewer",
	render: function() {
		return React.createElement("img", {src: this.props.src, alt: "", style: style});
	}
});

var plugin = {
	getComponent: function(props) {
		return React.createElement(ImageViewer, React.__spread({},  props));
	},
	test: function(extension) {
...
(function (global){
// Meant as a quick prototype
// note: I copied and pasted the 'web' folder of pdf.js from the stable git version
//       because the bower version does not include the viewer.js file
'use strict';

var React = require('react'),
	pdfJs = (typeof window !== "undefined" ? window['PDFJS'] : typeof global !== "undefined" ? global['PDFJS'] : null);

var plugin = {
	getComponent: function(props) {
		return React.createElement(NonNativeViewer, React.__spread({},  props));
	},
	test: function(extension) {
...
var NonNativeViewer = React.createClass({displayName: "NonNativeViewer",
	componentDidMount: function() {
		console.log(this.props.src);
		window.addEventListener('resize', this.handleResize);
		this.handleResize();
	},
	documentComplete: function(pdf) {
		self = this;
		pdf.getPage(1).then(function(page) {
			console.log('inGetPage');
			var canvas = self.getDOMNode();
			var context = canvas.getContext('2d');
			var scale = 1.0;
			var viewport = page.getViewport(scale);
	    	canvas.height = viewport.height; // these will need to update (watch for the resizing problem)
	...
	render: function() {
		// PdfJS doesn't like local files, to test:
		// install node http-server
		// http-server -o (in the react-ui-fileviewer folder)
		// '--cors' if you have problems
		return this.getIframeFromServer(this.props.src);
	},
	getCanvas: function() { // No chrome
		// temporarily here for ease of switching throw this function in componentDidMount
		pdfJs.getDocument('sample/' + this.props.src).then(
			this.documentComplete,
			function(){console.log('failure')}
		);
		var style = this.state.height ? { height: this.state.height } : null;
		return React.createElement("canvas", {ref: "wrapper", style: style}, " ")
	},
	getIframeFromServer: function(file) { // Using the PdfJS viewer
		// note: bower components have been changed since pdfJS doesn't include viewer.html in their package
		var fileSrc =  '../bower_components/pdfjs-dist/web/viewer.html?file=' + 'http://www.cbu.edu.zm/downloads/pdf-sample.pdf'; //+ '../../../sample/' + file;
		return React.createElement("iframe", {width: "500px", height: "400px", src: fileSrc});
	}
});
